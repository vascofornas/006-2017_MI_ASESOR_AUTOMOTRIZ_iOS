...
class Tramites2ViewController: UIViewController, UITextFieldDelegate,MFMailComposeViewControllerDelegate,MFMessageComposeViewControllerDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    var searchResults = [["Nombre": "Cargando tipos de trámites"]]
    ...
    func doSearch(_ searchWord: String)
    {
        ...
        // Create URL
        let myUrl = URL(string: "http://www.miasesorautomotriz.com/php_ios/scripts/getTramites.php")
                                    ...
                                    DispatchQueue.main.async {
                                        ...
                                        do {
                                            ...
                                            if let parseJSON = json {
                                                ...
                                                {
                                                    let primerName = ["Nombre": "Selecciona un trámite" ]
                                                    self.searchResults.append(primerName)
                                                    
                                                    for friendObj in friends
                                                    {
                                                        let fullName = ["Nombre": friendObj["tramite"] as! String]
    ...
    func pickerView(_ pickerView: UIPickerView, titleForRow row: Int, forComponent component: Int) -> String? {
        return searchResults[row]["Nombre"]!
    }
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        prefs.setValue(searchResults[row]["Nombre"], forKey: "miTramite")
        if let hh = UserDefaults.standard.object(forKey:"miTramite") as? String
        {
            print ("Tipo:" + hh)
        }
