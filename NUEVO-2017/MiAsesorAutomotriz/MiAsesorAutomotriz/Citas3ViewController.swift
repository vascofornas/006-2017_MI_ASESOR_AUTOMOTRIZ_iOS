...
class Citas3ViewController: UIViewController, UITextFieldDelegate,MFMailComposeViewControllerDelegate,MFMessageComposeViewControllerDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        prefs.setValue(searchResults[row]["Nombre"], forKey: "miModelo_Cita")
        if let hh = UserDefaults.standard.object(forKey:"miModelo_Cita") as? String
        {
            print (hh)
        }
