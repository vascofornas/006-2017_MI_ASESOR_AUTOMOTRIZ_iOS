...
class Costos2ViewController: UIViewController, UITextFieldDelegate,MFMailComposeViewControllerDelegate,MFMessageComposeViewControllerDelegate, UIPickerViewDelegate, UIPickerViewDataSource {
    ...
    var searchResults = [["Nombre": "Cargando modelos"]]
    ...
    func doSearch(_ searchWord: String)
    {
        ...
        // Create URL
        let myUrl = URL(string: "http://www.miasesorautomotriz.com/php_ios/scripts/getModelos.php")
                                    ...
                                    DispatchQueue.main.async {
                                        ...
                                        do {
                                            ...
                                            if let parseJSON = json {
                                                ...
                                                {
                                                    let primerName = ["Nombre": "Selecciona un modelo" ]
                                                    self.searchResults.append(primerName)
                                                    
                                                    for friendObj in friends
                                                    {
                                                        let fullName = ["Nombre": friendObj["nombre_modelo"] as! String]
    ...
    func pickerView(_ pickerView: UIPickerView, didSelectRow row: Int, inComponent component: Int) {
        ...
        prefs.setValue(searchResults[row]["Nombre"], forKey: "miModeloCita")
        if let hh = UserDefaults.standard.object(forKey:"miModeloCita") as? String
        {
            print (hh)
        }
